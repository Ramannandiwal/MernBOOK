...
<div  className=" my-12 min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div className="max-w-md mx-auto">
				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleSignUp} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<div className="relative">
                          ...
                          <p> if you have account .Please <Link className=' text-blue-700 underline' to='/login'>Login</Link></p>
						<div className="relative">
                ...
                <div className=' flex w-full items-center flex-col mt-5 gap-3'>
                    <button onClick={handleRegister}>login in with Google</button>
                </div>
			</div>
		</div>
	</div>
