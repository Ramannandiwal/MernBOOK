...
function Navbar() {
  ...
  return (
        <header className=' z-50 w-full bg-transparent fixed top-0 right-0 left-0 transition-all ease-in duration-300'>
                    ...
                    <ul className='md:flex space-x-12 hidden' >

                        {
                            navItems.map(({link,path})=>{
                              ...
                              {/* menu btn for the lg devices */}
                              <div className="space-x-12 hidden lg:flex items-center">
                                   <button> <FaBarsStaggered className=' w-5 hover:text-blue-700'/></button>

                              </div>
                    {/* {menu button for mobile divces} */}
